...
* You are utilising a computer using {platform.machine()} architecture with internet access.
* Find what browser is installed on your system and use it to navigate to the URL.
